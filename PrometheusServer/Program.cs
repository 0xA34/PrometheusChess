...
public class Program
{
    ...
    private static IServiceCollection ConfigureServices(IConfiguration configuration, CommandLineOptions options)
    {
        ...
        if (options.DevelopmentMode)
        {
            jwtSecret = $"DevMode_AutoGenerated_Secret_{Guid.NewGuid():N}";
        }
        else
        {
        ...
        if (!options.DevelopmentMode && jwtSecret.Contains("CHANGE_THIS"))
        {
        ...
        var dbConfig = new DatabaseConfiguration
        {
            ...
            UseInMemory = options.DevelopmentMode || configuration.GetValue("Database:UseInMemory", false)
        };
    ...
    private static void DisplayHelp()
    {
        ...
        Console.ForegroundColor = ConsoleColor.Gray;
        Console.WriteLine("      --development, --dev, -d    Run in development mode");
        Console.WriteLine("                                  - In-memory storage (no database required)");
        Console.WriteLine("                                  - Verbose logging (Debug level)");
        Console.WriteLine("                                  - Auto-generated JWT secret");
        Console.WriteLine("                                  - Higher rate limits for testing");
        Console.WriteLine();
    ...
    private static void DisplayDevelopmentModeBanner()
    {
        Console.WriteLine();
        Console.ForegroundColor = ConsoleColor.Yellow;
